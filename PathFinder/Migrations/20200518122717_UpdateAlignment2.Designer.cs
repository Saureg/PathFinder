...
namespace PathFinder.Migrations
{
    ...
    [Migration("20200518122717_UpdateAlignment2")]
    partial class UpdateAlignment2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PathFinder.Data.Models.CharClass", b =>
                {
                    ...
                    b.Property<List<int>>("AlignmentIdList")
                        .HasColumnType("integer[]");
            ...
            modelBuilder.Entity("PathFinder.Data.Models.Dictionaries.Alignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PathFinder.Data.Models.Dictionaries.Alignment", b =>
                {
                    b.HasOne("PathFinder.Data.Models.CharClass", null)
                        .WithMany("Alignments")
                        .HasForeignKey("CharClassId");
                });
