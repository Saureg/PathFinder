...
namespace PathFinder.Migrations
{
    ...
    [Migration("20200614134316_StartingWealthInClass")]
    partial class StartingWealthInClass
    {
            ...
            modelBuilder.Entity("PathFinder.Data.Models.CharClass.CharClass", b =>
                {
                    ...
                    b.Property<string>("StartingWealth")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("PathFinder.Data.Models.Character", b =>
                {
                    ...
                    b.HasOne("PathFinder.Data.Models.Users.User", "User")
                        .WithMany("Characters")
